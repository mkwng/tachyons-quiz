...
var AnswerForm = _react2.default.createClass({
  ...
  onAnswerChange: function onAnswerChange(e) {
  ...
  render: function render() {
    return _react2.default.createElement(
      ...
      _react2.default.createElement(
        ...
        'class="',
        _react2.default.createElement('input', { type: 'text', value: this.state.answer, onChange: this.onAnswerChange }),
        '"',
...
var Application = _react2.default.createClass({
  ...
  addQuestion: function addQuestion(num) {
    var num = num ? num : 1;
  ...
  nextQuestionID: function nextQuestionID() {
    ...
    var nextQuestion = this.state.currentQuestionID ? _.findIndex(this.state.data.questions, { id: this.state.currentQuestionID }) : -1;
  ...
  render: function render() {
    ...
    return _react2.default.createElement(
      'div',
      null,
      _react2.default.createElement(Question, { question: target.question }),
      _react2.default.createElement(AnswerForm, {
...
exports.default = function () {
  return _react2.default.createElement(Application, { questions: DATA.questions, myData: MYDATA });
};
    if (module.hot) {
      module.hot.accept()
